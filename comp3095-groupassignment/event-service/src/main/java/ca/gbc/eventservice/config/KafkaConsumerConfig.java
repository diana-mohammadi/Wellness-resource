...
import ca.gbc.eventservice.event.GoalCompletedEvent;
...
public class KafkaConsumerConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:event-service-group}")
    ...
    public ConsumerFactory<String, GoalCompletedEvent> consumerFactory() {
        ...
        JsonDeserializer<GoalCompletedEvent> deserializer = new JsonDeserializer<>(GoalCompletedEvent.class);
